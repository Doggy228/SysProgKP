...
public class Expr_ArithPlus extends Expr_Arith {
    public Expr_ArithPlus(int row, int col, Expr value1, Expr value2, Env env) {
        super(row, col, value1, value2, env);
    }

    public Expr_ArithPlus(int row, int col, Expr value1, Expr value2, Expr_IdTemp result) {
    ...
    public Expr gen(Program prg) throws CompileException, IOException {
        ...
        return new Expr_ArithPlus(getRow(), getCol(), value1r, value2r, getResult());
    }
